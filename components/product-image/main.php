...
$product = [
    ...
    "main_model" => "https://www.bulkapparel.com/image/fashion-wear/16_fm.jpg",
    "colors" => [
        [
            "hex" => "#fdfdfd",
            "colorName" => "White",
        ...
        [
            "hex" => "#55513e",
            "colorName" => "Heather Military Green",
            "featured" => 0
        ],
        ...
        [
            "hex" => "#db86c7",
            "colorName" => "Heather Radiant Orchid",
            "featured" => 0
        ],
                    ...
                    <div class="col col-4">
                        <div class="row no-gutters">
                            ...
                            <div class="col pl-3">
                                ...
                                <?php $colorList = $product['colors'];
                                include('./components/product-image/select/choose-color-select.php') ?>
                            </div>
                        </div>
                    </div>
                    <div class="col col-8">
