    ...
    if ($(e.target).hasClass('viewstyleid')) {
		...
		$.ajax({
			...
			success: function (msg) {
				...
				$("#customseo").prop('disabled', true); //Start - Remove ability to change custom URL (slug) from product edit - Roi - 07/20/2020

                productSearchCard.removeClass(productSearchSelected)
                $(this).addClass(productSearchSelected);
                searchSidebarTabs.show()
