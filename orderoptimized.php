...
<body>
    ...
    <main class="new-admin order-page">
        <aside>
            <?php include('./components/orderoptimized/sidebar/orderlist-sidebar.php') ?>
        </aside>

        <?php include('./components/orderoptimized/main.php') ?>

        <aside>
            <?php include('./components/orderoptimized/sidebar/log-sidebar.php') ?>
        </aside>
    </main>
    <?php include('./components/orderoptimized/modals/OrderTrackingModal.php') ?>
